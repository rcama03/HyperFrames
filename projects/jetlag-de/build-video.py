#!/usr/bin/env python3
"""
Assembles the jetlag-de video using FFmpeg.
...
ZOOM_TIMES  = [66.0, 107.1, 159.3, 177.9, 209.5, 287.2, 328.2, 345.7, 390.0, 425.2, 465.1, 503.9]
# Dramatic moments: hook stat + big midpoint + finale
SHAKE_TIMES = [2.5, 209.5, 567.8]
