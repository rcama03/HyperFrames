#!/usr/bin/env python3
"""
build-video.py — luegen-de
"7 Sauerstoff-Lügen im Flieger — Nr. 4 rettet dir das Leben"

Source video: 595.6s  |  Voiceover: 613.56s
Video is shorter than voiceover — last frame is frozen via tpad to reach VOICE_DUR.
"""
import json
import subprocess
import sys
...
MUSIC_VOL  = 0.24   # slightly louder than previous videos (was 0.19)
SWOOSH_VOL = 0.35
SRC_OFFSET = 1.5    # skip dark intro frames
