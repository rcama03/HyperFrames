...
ZOOM_TIMES  = [0.0, 81.6, 168.1, 257.4, 341.0, 420.7, 513.9]

SHAKE_TIMES = [72, 107, 223, 245, 283, 310]

SWOOSH_CARD_TIMES = [
    0.0, 81.6, 168.1, 257.4, 341.0, 420.7, 513.9,          # chapters
    72, 107, 223, 245, 283, 310,                              # stats
    122, 148, 160, 328,                                       # alerts
    40, 205, 268, 413, 500,                                   # keys
    140, 285,                                                  # definitions
    480,                                                       # quote
    76, 350, 470,                                              # sources
    395,                                                       # rank
...
def main():
    SRT_SRC = '/root/.claude/uploads/bf195af2-7fab-5825-a36f-49fc2b3be335/2f502155-captions.srt'
