...
ZOOM_TIMES  = [0.0, 36.1, 114.1, 174.6, 293.5, 470.0]

SHAKE_TIMES = [24, 126, 308, 420]

SWOOSH_CARD_TIMES = [
    0.0, 36.1, 76.1, 96.5, 114.1, 152.1, 174.6, 233.1, 251.6, 293.5,
    24, 126, 308, 348,
    43, 300,
    63, 378, 420,
    85, 195, 338, 455,
...
def main():
    SRT_SRC = '/root/.claude/uploads/bf195af2-7fab-5825-a36f-49fc2b3be335/99bd6f6d-captions.srt'
