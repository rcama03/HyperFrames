...
Style: Default,Montserrat,44,&H00FFFFFF,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,2,1,2,30,30,60,1
Style: Highlight,Montserrat,44,&H0000D7FF,&H000000FF,&H00000000,&H80000000,-1,0,0,0,100,100,0,0,1,2,1,2,30,30,60,1
...
"""
    ...
    for line in lines:
        ...
        for wi, word in enumerate(line):
            ...
            text = "".join(parts)
            # Add frosted pill background via border style hack
            # Use \bord4\shad0\4a&H72& for pill effect
            text = r"{\bord0\shad1\be1}" + text
