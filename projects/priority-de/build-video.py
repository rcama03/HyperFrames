#!/usr/bin/env python3
"""
Assembles the priority-de video using FFmpeg.
...
ZOOM_TIMES  = [43.1, 81.5, 116.2, 172.9, 213.6, 249.1, 285.0, 341.3, 444.3]
# Dramatic moments: hook stat + Lüge 4 Restaurantfalle + Industrie reveal
SHAKE_TIMES = [2.5, 172.9, 444.3]
