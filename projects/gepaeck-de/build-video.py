#!/usr/bin/env python3
"""
Assembles the gepaeck-de video using FFmpeg.
...
# Chapter card inTimes (scaled timeline) — no first card (hook rule)
ZOOM_TIMES  = [93.5, 183.3, 274.1, 351.9, 457.7, 536.4]
# Dramatic stat reveals
SHAKE_TIMES = [2.5, 35.8, 355.0]
...
if result.returncode == 0:
    ...
    print(f"  Size: {size/1024/1024:.0f} MB  ({WIDTH}x{HEIGHT}, CRF 27)")
else:
    print("FFmpeg error:")
