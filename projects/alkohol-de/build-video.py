#!/usr/bin/env python3
"""
Assembles the alkohol-de video using FFmpeg.
...
ZOOM_TIMES  = [44.6, 75.2, 106.4, 137.3, 167.8, 211.0, 243.2, 277.2]
# Dramatic moments: hook stat + Lüge 4 + Lüge 8
SHAKE_TIMES = [2.5, 137.3, 277.2]
