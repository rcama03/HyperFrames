#!/usr/bin/env python3
"""
build-video.py — etias-de
"Was ETIAS 2026 WIRKLICH fuer dich bedeutet — die Wahrheit"

Source video: 1280×720, 631.9s  |  Voiceover: 644.3s
...
if result.returncode == 0:
    ...
    print(f"  Size: {size/1024/1024:.0f} MB  ({WIDTH}×{HEIGHT}, CRF 25)")
else:
    print("FFmpeg error:")
