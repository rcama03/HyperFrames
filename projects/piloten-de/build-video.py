#!/usr/bin/env python3
"""
build-video.py — piloten-de
"8 Piloten-Schichtlügen — Nr. 5 gefährdet dich wirklich"

Source video: 536.3s  |  Voiceover: 536.3s  (nearly identical — no padding needed)
...
MUSIC_VOL  = 0.24   # audible during silences
SWOOSH_VOL = 0.35
SRC_OFFSET = 1.0    # skip dark intro frames
...
DURATION     = min(VIDEO_DUR - SRC_OFFSET, VOICE_DUR)  # end when shorter ends
