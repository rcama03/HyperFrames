#!/usr/bin/env python3
"""
Assembles the sauerstoff-de video using FFmpeg.

Features:
  - External voiceover replaces source audio
  - Word-level gold-highlight captions (ASS)
  - Motion graphics cards + chapter marker cards (16 total)
...
# ── ✏️  EDIT THESE ─────────────────────────────────────────────────────────────
MUSIC_VOL  = 0.19   # background music volume (0.0–1.0)
SWOOSH_VOL = 0.35   # swoosh SFX volume
SRC_OFFSET = 1.5    # skip dark fade-in intro; content visible from ~1.5s
