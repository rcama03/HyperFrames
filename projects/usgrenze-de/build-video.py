...
ZOOM_TIMES  = [0.0, 86.6, 103.2, 137.2, 192.7, 265.7, 319.2, 379.6, 452.5, 488.6]

SHAKE_TIMES = [25, 125, 225, 295, 355, 505]

SWOOSH_CARD_TIMES = [
    0.0, 86.6, 103.2, 137.2, 192.7, 265.7, 319.2, 379.6, 452.5, 488.6,  # chapters
    25, 125, 225, 295, 355, 505,                                           # stats
    55, 115, 240, 555,                                                     # alerts
    93, 148, 280, 430, 465,                                                # keys
    210, 340,                                                              # definitions
    600,                                                                   # quote
    35, 300, 360,                                                          # sources
    478,                                                                   # rank
...
def main():
    SRT_SRC = '/root/.claude/uploads/bf195af2-7fab-5825-a36f-49fc2b3be335/2e6ab102-captions.srt'
