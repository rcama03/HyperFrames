#!/usr/bin/env python3
"""
Assembles the packing-de video using FFmpeg.
...
# Trigger zoom on chapter card inTimes (scaled timestamps)
ZOOM_TIMES  = [0.5, 81.7, 176.2, 254.2, 346.7, 446.1]

# Trigger shake on dramatic stat reveals
SHAKE_TIMES = [5.0, 67.3, 136.5, 315.5, 362.6]
