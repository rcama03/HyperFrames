...
ZOOM_TIMES  = [0.0, 97.4, 130.5, 186.0, 273.6, 379.7, 440.0]

SHAKE_TIMES = [8, 140, 285, 415, 470]

SWOOSH_CARD_TIMES = [
    0.0, 97.4, 130.5, 186.0, 220.1, 273.6, 306.7, 364.2, 379.7,
    8, 140, 285, 112, 200,
    470, 440,
    340, 415, 355,
    148, 165, 370, 192,
...
def main():
    SRT_SRC = '/root/.claude/uploads/bf195af2-7fab-5825-a36f-49fc2b3be335/82fa0149-captions.srt'
