...
ZOOM_TIMES  = [0.0, 47.7, 102.1, 151.8, 204.3]

SHAKE_TIMES = [22, 143, 215]

SWOOSH_CARD_TIMES = [
    0.0, 47.7, 102.1, 151.8, 204.3,       # chapters
    22, 143, 215,                            # stats
    110, 180,                                # alerts
    158, 169, 200,                           # keys
    70,                                      # definition
...
def main():
    SRT_SRC = '/root/.claude/uploads/bf195af2-7fab-5825-a36f-49fc2b3be335/d3a1a4c1-captions.srt'
