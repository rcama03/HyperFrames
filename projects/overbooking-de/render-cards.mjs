...
const cards = [
  // ── CHAPTER CARDS (5) — top-left, cyan ─────────────────────────────────────
  { id: 'chap-01', type: 'chapter', inTime: 0.0,    outTime: 5.0,    html: buildChapter('Schock Am Gate') },
  { id: 'chap-02', type: 'chapter', inTime: 47.7,   outTime: 52.7,   html: buildChapter('WM-Fans Als Zielscheibe') },
  { id: 'chap-03', type: 'chapter', inTime: 102.1,  outTime: 107.1,  html: buildChapter('Trick Mit Dem Gutschein') },
  { id: 'chap-04', type: 'chapter', inTime: 151.8,  outTime: 156.8,  html: buildChapter('Payoff: Dein Schutzplan') },
  { id: 'chap-05', type: 'chapter', inTime: 204.3,  outTime: 209.3,  html: buildChapter('WM-Kontext: Besonders Gefährdet') },

  // ── STAT CARDS (3) — bottom-left, gold ─────────────────────────────────────
  { id: 'stat-500k',   type: 'stat', inTime: 22,  outTime: 30,  html: buildStat('500.000', 'Passagiere jährlich unfreiwillig verdrängt', '✈️') },
  { id: 'stat-27pct',  type: 'stat', inTime: 143, outTime: 151, html: buildStat('27%',     'Der Betroffenen fordern gesetzliche Entschädigung', '📊') },
  { id: 'stat-15pct',  type: 'stat', inTime: 215, outTime: 223, html: buildStat('15%',     'Mehr Tickets als Plätze auf WM-Routen', '📈') },

  // ── ALERT CARDS (2) — bottom-left, red ─────────────────────────────────────
  { id: 'alert-gutschein', type: 'alert', inTime: 110, outTime: 117, html: buildAlert('Gutscheine = Rechtsverzicht! Gesetzlicher Anspruch oft höher als 300€ Gutschein!', 'WARNUNG') },
  { id: 'alert-niemals',   type: 'alert', inTime: 180, outTime: 187, html: buildAlert('Niemals sofort Ja sagen — erst schriftlich nach dem Grund fragen!', 'ACHTUNG') },

  // ── KEY CARDS (3) — bottom-left, orange ────────────────────────────────────
  { id: 'key-checkin',    type: 'key', inTime: 158, outTime: 166, html: buildKey('Immer online einchecken, so früh wie möglich — weniger Risiko auf der Streichliste', 'SCHUTZPLAN') },
  { id: 'key-screenshot', type: 'key', inTime: 169, outTime: 177, html: buildKey('Boarding Pass und Buchungsbestätigungen IMMER als Screenshot auf dem Handy', 'BEWEIS') },
  { id: 'key-airhelp',    type: 'key', inTime: 200, outTime: 208, html: buildKey('Nationale Durchsetzungsstellen oder Portale wie AirHelp nutzen — nur Provision im Erfolgsfall', 'TIPP') },

  // ── DEFINITION CARD (1) — top-left, teal ──────────────────────────────────
  { id: 'def-eu261', type: 'definition', inTime: 70, outTime: 78, html: buildDefinition('EU-Verordnung 261/2004', 'Gilt für alle Flüge ab EU-Flughafen und für Flüge in die EU mit EU-Airline') },

  // ── QUOTE CARD (1) — bottom-left, purple ──────────────────────────────────
  { id: 'quote-macht', type: 'quote', inTime: 230, outTime: 237, html: buildQuote('Für jeden WM-Fan, der seine Rechte kennt, verliert eine Airline ein kleines Stück ihrer Macht.', 'Passagierrechte WM 2026') },

  // ── SOURCE CARDS (2) — bottom-right, green ────────────────────────────────
  { id: 'src-eu',   type: 'source', inTime: 88,  outTime: 95,  html: buildSource('EU-Verordnung 261/2004 — Fluggastrechte') },
  { id: 'src-eugh', type: 'source', inTime: 135, outTime: 142, html: buildSource('Europäischer Gerichtshof — Overbooking-Urteil') },

  // ── RANK CARD (1) — bottom-left, amber ────────────────────────────────────
  { id: 'rank-600', type: 'rank', inTime: 90, outTime: 98, html: buildRank('€600', 'MAXIMALE ENTSCHÄDIGUNG', 'Pro Person, sofort, bar — kein Gutschein') },
];
