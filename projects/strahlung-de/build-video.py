#!/usr/bin/env python3
"""
build-video.py — strahlung-de
"8 Strahlen-Wahrheiten im Flieger — Nr. 5 trifft Vielflieger sofort"

Steps:
  1. Run render-cards.mjs first to generate card-frames/ + card-manifest.json
  2. Voiceover: voiceover.mp3 (560.688s)
  3. Run:
...
# ── ✏️  EDIT THESE ─────────────────────────────────────────────────────────────
MUSIC_VOL  = 0.24   # background music volume (0.0–1.0)
SWOOSH_VOL = 0.35   # swoosh SFX volume
SRC_OFFSET = 0.0    # seconds to skip at start of source
